<template>
    <chart-section :title="t(`grapesjs-echarts-presets.config.parallelAxis.label`)">
        <div class="gjs-trt-traits gjs-one-bg gjs-two-color">
            <ep-number-input :label="t('grapesjs-echarts-presets.config.axis.dim.label')" v-model="axis.dim" :min="0"></ep-number-input>
            <ep-number-input :label="t('grapesjs-echarts-presets.config.axis.parallelIndex.label')" v-model="axis.parallelIndex" :min="0"></ep-number-input>
            <ep-check-box :label="t('grapesjs-echarts-presets.config.axis.realtime.label')" v-model="axis.realtime"></ep-check-box>
            <area-style-editor :title="t('grapesjs-echarts-presets.config.axis.areaSelectStyle.label')" v-model="axis.areaSelectStyle"></area-style-editor>
    ...
    data() {
      return {
        axis: {
          ...
          parallelIndex: 0,
          realtime: true,
          areaSelectStyle: Object.assign({}, AREA_STYLE),
          type: "value",
          name: "",
          nameLocation: "end",

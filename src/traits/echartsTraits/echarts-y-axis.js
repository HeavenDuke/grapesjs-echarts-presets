import AxisEditor from "../../vue/echartsEditors/cartesian-axis-editor.vue";
export default {
  ...
  onEvent({ component }) {
    ...
    component.addAttributes({
      "data-ecg-y-axis": JSON.stringify(axis)
    });
    component.clearChart()
    component.view.render();
  },
  onUpdate({ component }) {
    const axis = component.getAttributes()["data-ecg-y-axis"] || null;

import AxisEditor from "../../vue/echartsEditors/angle-axis-editor.vue";
export default {
  ...
  onEvent({ component }) {
    ...
    component.addAttributes({
      "data-ecg-angle-axis": JSON.stringify(axis)
    });
    component.clearChart()
    component.view.render();
  },
  onUpdate({ component }) {
    const axis = component.getAttributes()["data-ecg-angle-axis"] || null;
